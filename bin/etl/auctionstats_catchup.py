...
from cliquesadmin.gce_utils.bigquery import BigQueryMongoETL, cliques_bq_settings, BqMongoKeywordETL
...
if __name__ == '__main__':
    ...
    datetimes = [datetime(2017, 11, 9, h) for h in range(13, 15)] #for n in range(1,2)]
